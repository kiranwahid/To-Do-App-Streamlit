# There are times where we want to return different things from a function based on some condition. To practice
# this idea, imagine that we want to check if someone is an adult. We might check their age and return different 
...
def is_adult(age):
    if age >= ADULT_AGE:
        print("Enter age is an adult ")
        return True
    else:
        print("Enter age is not anadult ")
        return False
